...
const mockTenders: Tender[] = [
  {
    ...
    description: 'Achat de 5 ordinateurs portables pour le département d\'informatique',
  ...
  },
  {
    ...
    description: 'Achat de 3 imprimantes laser pour le département d\'administration',
  ...
  },
  {
    ...
    description: 'Acquisition de matériel informatique pour le laboratoire de recherche',
...
const suppliersSlice = createSlice({
  ...
  reducers: {
    ...
    blacklistSupplier: (state, action: PayloadAction<{ id: string; reason: string }>) => {
      const index = state.suppliers.findIndex(s => s.id === action.payload.id);
      if (index !== -1) {
